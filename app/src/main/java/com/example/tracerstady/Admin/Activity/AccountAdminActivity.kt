...
class AccountAdminActivity : AppCompatActivity() {
    ...
    private lateinit var tracer_alumni: LinearLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tracer_alumni = findViewById(R.id.tracer_alumni)
        ...
        tracer_alumni.setOnClickListener {
            startActivity(Intent( this, QueryAndSearchAlumniActivity::class.java))
        }
