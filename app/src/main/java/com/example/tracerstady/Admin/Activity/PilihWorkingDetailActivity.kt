...
class PilihWorkingDetailActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pilih_working_detail)
    ...
    private fun getRate(judul: String?) {
        reference = FirebaseDatabase.getInstance().reference
            .child("Working").child(judul!!).child("Rate")
        reference.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if(dataSnapshot.exists()) {
                    ...
                    rateAdapter = RateAdapter(mWorking, this@PilihWorkingDetailActivity)
