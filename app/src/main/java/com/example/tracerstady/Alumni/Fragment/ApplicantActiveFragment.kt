...
class ApplicantActiveFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_applicant_active, container, false)
    ...
    private fun getApplicant(userid: String) {
        ...
        reference.orderByChild("status").equalTo("Applicant Aktif")
